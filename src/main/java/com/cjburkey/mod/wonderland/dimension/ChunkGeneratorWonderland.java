...
public class ChunkGeneratorWonderland implements IChunkGenerator {
	
	protected static final IBlockState FILLERBLOCK = Blocks.SNOW.getDefaultState();
	...
	public ChunkGeneratorWonderland(World worldIn, long seed) {
		this.settings = new Factory().build();
		this.world = worldIn;
					...
					for (int j2 = 0; j2 < 8; ++j2)
					{
						...
						for (int k2 = 0; k2 < 4; ++k2)
						{
							...
							for (int l2 = 0; l2 < 4; ++l2)
							{
								...
								{
									primer.setBlockState(i * 4 + k2, i2 * 8 + j2, l * 4 + l2, FILLERBLOCK);
								}
